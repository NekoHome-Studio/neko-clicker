...
| 4 | 猫娘文明 | 文明演进 | 时代更替至星际 | ✅ | ✅ | – | — | ✅ **已落地**：`src/NekoClicker.Content.Civ/` |
| 5 | 赛博猫娘 | 数字层 | 迁服务器 | ✅ | ✅ | – | — | ✅ **已落地**：`src/NekoClicker.Content.Cyber/` |
| 6 | 猫娘末世 | 后人类 | 重启文明，保留上纪元猫娘 | ✅ | ✅ | – | **跨转生继承** | ✅ **已落地**：`src/NekoClicker.Content.Apocalypse/` |
| 7 | 猫娘神明 | 轻松搞笑 meta | 切换神话体系 | ✅ | ✅ | – | — | ✅ **已落地**：`src/NekoClicker.Content.God/` |
| 8 | 猫娘梦境 | 梦层 | 梦醒 / 入梦嵌套 | ✅ | ✅ | – | — | ✅ **已落地**：`src/NekoClicker.Content.Dream/` |
...
3. **一旦 `Era` 到位，#4 文明 / #5 赛博 / #7 神明 / #8 梦境 就退化为"换皮"**：
   ...
   ✅ **已在阶段 5 全部交付**（四个包核心零改动，见 `docs/ROADMAP.md` 阶段 5 与
...
| **5** | **#4 文明 / #5 赛博 / #7 神明 / #8 梦境** | 全是 `Era` 的换皮，可批量生产（内容成本 ≈ 一个包）。<br>✅ **已完成**（2026-09-26）：四个包各 9 建筑 / ≥48 升级 / ≥65 成就 / 40 条叙事 / 5 层 / 2~3 结局，**核心零改动**，用例 320 → 394 |
